package sg.howard.twitterclient.imagefragment;
...
public class ImageDialogFragment extends BlurDialogFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        img_url = args.getString(IMAGE_URL);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.view_image_previewer, null);
        ImageView label = view.findViewById(R.id.previewer_image);
